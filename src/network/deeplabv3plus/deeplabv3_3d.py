...
from src.network.deeplabv3plus.aspp import ASPP, ASPP_Bottleneck
from src.network.deeplabv3plus.resnet import (ResNet101_OS16, ResNet152_OS16,
                                              ResNet18_OS16,
                                              ResNet18_OS8, ResNet34_OS16,
                                              ResNet34_OS8,
                                              ResNet50_OS16)
...
class DeepLabV3_3D(nn.Module):
    def __init__(
        self, num_classes, input_channels, resnet, last_activation=None
    ):
        ...
        if resnet.lower() in ['resnet50_os16', 'resnet101_os16',
                              'resnet152_os16']:
    ...
    def forward(self, x):
        ...
        output = F.interpolate(
            output, size=(h, w, c), mode='trilinear', align_corners=True
        )
