...
class ASPP(nn.Module):
    ...
    def forward(self, feature_map):
        feature_map_h = feature_map.cube_size()[2]
        feature_map_w = feature_map.cube_size()[3]
        feature_map_c = feature_map.cube_size()[4]
        ...
        out_img = F.interpolate(
            out_img, size=(feature_map_h, feature_map_w, feature_map_c),
